...
import com.metasv.client.openapi.model.AsyncBroadcastResult;
...
public class TxApi {
    ...
    /**
     * Build call for txBroadcastAsyncPost
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 201 </td><td> Acknowledged. txid returned dsha256(rawHex). </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call txBroadcastAsyncPostCall(TxRaw txRaw, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = txRaw;

        // create path and map variables
        String localVarPath = "/tx/broadcast/async";
    ...
    private okhttp3.Call txBroadcastAsyncPostValidateBeforeCall(TxRaw txRaw, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = txBroadcastAsyncPostCall(txRaw, _callback);
        return localVarCall;
     ...
     */
    public String txBroadcastAsyncPost(TxRaw txRaw) throws ApiException {
        ApiResponse<String> localVarResp = txBroadcastAsyncPostWithHttpInfo(txRaw);
     ...
     */
    public ApiResponse<String> txBroadcastAsyncPostWithHttpInfo(TxRaw txRaw) throws ApiException {
        okhttp3.Call localVarCall = txBroadcastAsyncPostValidateBeforeCall(txRaw, null);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Broadcast tx to metasv asyn(tx size no bigger than 250K). (asynchronously)
     * This api will not broadcast to metasv fullnode directly, the tx will be cached and later send to fullnode.
     * @param txRaw  (optional)
     ...
     */
    public okhttp3.Call txBroadcastAsyncPostAsync(TxRaw txRaw, final ApiCallback<String> _callback) throws ApiException {

        okhttp3.Call localVarCall = txBroadcastAsyncPostValidateBeforeCall(txRaw, _callback);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for txBroadcastAsyncTxidStateGet
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Acknowledged. txid returned dsha256(rawHex). </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call txBroadcastAsyncTxidStateGetCall(String txid, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/tx/broadcast/async/{txid}/state"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call txBroadcastAsyncTxidStateGetValidateBeforeCall(String txid, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'txid' is set
        if (txid == null) {
            throw new ApiException("Missing the required parameter 'txid' when calling txBroadcastAsyncTxidStateGet(Async)");
        }
        

        okhttp3.Call localVarCall = txBroadcastAsyncTxidStateGetCall(txid, _callback);
        return localVarCall;
     ...
     */
    public AsyncBroadcastResult txBroadcastAsyncTxidStateGet(String txid) throws ApiException {
        ApiResponse<AsyncBroadcastResult> localVarResp = txBroadcastAsyncTxidStateGetWithHttpInfo(txid);
        return localVarResp.getData();
    }
     ...
     * Use this api to query async broadcast status, possible status PENDING, BROADCASTED, INVALID, UNKNOWN
     * @param txid the request ID to search, txhash (required)
     * @return ApiResponse&lt;AsyncBroadcastResult&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<AsyncBroadcastResult> txBroadcastAsyncTxidStateGetWithHttpInfo(String txid) throws ApiException {
        okhttp3.Call localVarCall = txBroadcastAsyncTxidStateGetValidateBeforeCall(txid, null);
        Type localVarReturnType = new TypeToken<AsyncBroadcastResult>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Query aync broadcast result. (asynchronously)
     * Use this api to query async broadcast status, possible status PENDING, BROADCASTED, INVALID, UNKNOWN
     * @param txid the request ID to search, txhash (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call txBroadcastAsyncTxidStateGetAsync(String txid, final ApiCallback<AsyncBroadcastResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = txBroadcastAsyncTxidStateGetValidateBeforeCall(txid, _callback);
        Type localVarReturnType = new TypeToken<AsyncBroadcastResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
