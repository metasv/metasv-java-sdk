...
public class AddressApi {
     ...
     * @param address the requested address (required)
     * @param flag The last flag of the last query record(Paging flag) (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Get address transactions success. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call addressAddressTxGetCall(String address, String flag, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call addressAddressTxGetValidateBeforeCall(String address, String flag, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = addressAddressTxGetCall(address, flag, _callback);
        return localVarCall;
     ...
     */
    public List<AddressTx> addressAddressTxGet(String address, String flag) throws ApiException {
        ApiResponse<List<AddressTx>> localVarResp = addressAddressTxGetWithHttpInfo(address, flag);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<AddressTx>> addressAddressTxGetWithHttpInfo(String address, String flag) throws ApiException {
        okhttp3.Call localVarCall = addressAddressTxGetValidateBeforeCall(address, flag, null);
        Type localVarReturnType = new TypeToken<List<AddressTx>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get address history by specific address(Only recent 3 months available, Use super address apis if you need more history). (asynchronously)
     * 
     * @param address the requested address (required)
     * @param flag The last flag of the last query record(Paging flag) (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call addressAddressTxGetAsync(String address, String flag, final ApiCallback<List<AddressTx>> _callback) throws ApiException {

        okhttp3.Call localVarCall = addressAddressTxGetValidateBeforeCall(address, flag, _callback);
        Type localVarReturnType = new TypeToken<List<AddressTx>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param confirmed Whether the utxo is confirmed, true for confirmed utxo, false for unconfirmed utxo, null for all utxos. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call addressAddressUtxoGetCall(String address, Long flag, String confirmed, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call addressAddressUtxoGetValidateBeforeCall(String address, Long flag, String confirmed, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = addressAddressUtxoGetCall(address, flag, confirmed, _callback);
        return localVarCall;
     ...
     */
    public List<AddressUtxo> addressAddressUtxoGet(String address, Long flag, String confirmed) throws ApiException {
        ApiResponse<List<AddressUtxo>> localVarResp = addressAddressUtxoGetWithHttpInfo(address, flag, confirmed);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<AddressUtxo>> addressAddressUtxoGetWithHttpInfo(String address, Long flag, String confirmed) throws ApiException {
        okhttp3.Call localVarCall = addressAddressUtxoGetValidateBeforeCall(address, flag, confirmed, null);
     ...
     */
    public okhttp3.Call addressAddressUtxoGetAsync(String address, Long flag, String confirmed, final ApiCallback<List<AddressUtxo>> _callback) throws ApiException {

        okhttp3.Call localVarCall = addressAddressUtxoGetValidateBeforeCall(address, flag, confirmed, _callback);
        Type localVarReturnType = new TypeToken<List<AddressUtxo>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
